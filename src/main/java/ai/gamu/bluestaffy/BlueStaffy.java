...
public class BlueStaffy {
    ...
    // Create a Deferred Register to hold Blocks which will all be registered under the "bluestaffy" namespace
    ...
    // Creates a new Block with the id "bluestaffy:example_block", combining the namespace and path
    public static final DeferredBlock<Block> EXAMPLE_BLOCK = BLOCKS.registerSimpleBlock("example_block", p -> p.mapColor(MapColor.STONE));
    // Creates a new BlockItem with the id "bluestaffy:example_block", combining the namespace and path
    public static final DeferredItem<BlockItem> EXAMPLE_BLOCK_ITEM = ITEMS.registerSimpleBlockItem("example_block", EXAMPLE_BLOCK);

    // Creates a new food item with the id "bluestaffy:example_id", nutrition 1 and saturation 2
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EXAMPLE_TAB = CREATIVE_MODE_TABS.register("example_tab", () -> CreativeModeTab.builder()
            .title(Component.translatable("itemGroup.bluestaffy")) //The language key for the title of your CreativeModeTab
